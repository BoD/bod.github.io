...
<%@include file="/include/header1.jspf" %>
		...
		<div id="blurb">
		Here you can find a few projects I've worked on.  Non exhaustive list.
		</div>
		...
		<div id="projects">
			...
			<div>
				<h1>Logcat Live Wallpaper (for Android)</h1>
				<pre>
			...
			<div>
				<h1>Express Yourself! Buttons (for Android)</h1>
				<pre>
					Collect, create and share thousands of 80s style buttons.
